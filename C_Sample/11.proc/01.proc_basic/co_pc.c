...
static unsigned int sqlctx = 18899;
...
{12,4130,1,0,0,
5,0,0,1,0,0,32,37,0,0,0,0,0,1,0,
20,0,0,0,0,0,27,58,0,0,4,4,0,1,0,1,97,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
51,0,0,3,0,0,32,64,0,0,0,0,0,1,0,
66,0,0,4,0,0,30,81,0,0,0,0,0,1,0,
81,0,0,5,0,0,17,132,0,0,1,1,0,1,0,1,97,0,0,
100,0,0,5,0,0,45,135,0,0,0,0,0,1,0,
115,0,0,5,0,0,13,144,0,0,1,0,0,1,0,2,9,0,0,
134,0,0,5,0,0,15,150,0,0,0,0,0,1,0,
149,0,0,5,0,0,15,157,0,0,0,0,0,1,0,
164,0,0,5,0,0,17,177,0,0,1,1,0,1,0,1,97,0,0,
183,0,0,5,0,0,45,180,0,0,2,2,0,1,0,1,97,0,0,1,97,0,0,
206,0,0,5,0,0,13,189,0,0,1,0,0,1,0,2,9,0,0,
225,0,0,5,0,0,15,195,0,0,0,0,0,1,0,
240,0,0,5,0,0,15,204,0,0,0,0,0,1,0,
};
...
struct { unsigned short len; unsigned char arr[101]; } sysdate;
...

{
    ...
    sqlstm.sqlety = (unsigned short)4352;
    sqlstm.occurs = (unsigned int  )0;
    sqlstm.sqhstv[0] = (unsigned char  *)stmt;
    sqlstm.sqhstl[0] = (unsigned long )20000;
...

{
        ...
        sqlstm.sqhstv[0] = (unsigned char  *)&sysdate;
...
void selDualPlg() {
    ...
    /* EXEC SQL BEGIN DECLARE SECTION; */ 
            ...
            /* VARCHAR enc[100+1]; */ 
struct { unsigned short len; unsigned char arr[101]; } enc;
...

{
    ...
    sqlstm.occurs = (unsigned int  )0;
    sqlstm.sqcmod = (unsigned int )0;
    sqlstm.sqhstv[0] = (unsigned char  *)plain;
...

{
        ...
        sqlstm.sqfoff = (         int )0;
        sqlstm.sqfmod = (unsigned int )2;
        sqlstm.sqhstv[0] = (unsigned char  *)&enc;
        sqlstm.sqhstl[0] = (unsigned long )103;
        sqlstm.sqhsts[0] = (         int  )0;
        sqlstm.sqindv[0] = (         short *)0;
        sqlstm.sqinds[0] = (         int  )0;
