...
echo  ============================
proc  iname=co_pc include=$HOME/include CHAR_MAP=CHARZ
...
'AIX')
    ...
    $CCHOME/cc -o co_pc co_pc.c -brtl -q64 -L$HOME/lib -I$HOME/include -lCOencapi -L$ORACLE_HOME/lib -lclntsh
...
'Linux')
    ...
    $CCHOME/cc -o co_pc co_pc.c -L$HOME/lib -I$HOME/include -lCOencapi -lm -L$ORACLE_HOME/lib -lclntsh
