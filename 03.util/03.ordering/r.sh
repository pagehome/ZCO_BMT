...
echo
echo  ====================================================================================================
echo  === [1] $JAVAHOME/java -classpath .:$HOME/lib/CubeOneAPI.jar co_ordering
echo  ====================================================================================================
# use environment ..
#$JAVAHOME/java -d64 -classpath .:$HOME/lib/CubeOneAPI.jar co_ordering
$JAVAHOME/java -d64 -classpath .:$HOME/lib/CubeOneAPI.jar co_ordering

# use java-option 
#$JAVAHOME/java -classpath .:$HOME/lib/CubeOneAPI.jar -Djava.library.path=$HOME/lib co_ordering
