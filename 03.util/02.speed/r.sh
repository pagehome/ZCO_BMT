...
echo
echo  ====================================================================================================
echo  === [1] $JAVAHOME/java -classpath .:$HOME/lib/CubeOneAPI.jar co_speed
echo  ====================================================================================================
# use environment ..
#$JAVAHOME/java -d64 -classpath .:$HOME/lib/CubeOneAPI.jar co_speed
$JAVAHOME/java -d64 -classpath .:$HOME/lib/CubeOneAPI.jar co_speed

# use java-option 
#$JAVAHOME/java -classpath .:$HOME/lib/CubeOneAPI.jar -Djava.library.path=$HOME/lib co_speed
