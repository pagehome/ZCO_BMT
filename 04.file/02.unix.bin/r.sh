...
$JAVAHOME/java -d64 co_file unix.pdf.bin $DBNAME $osname


echo
echo  ====================================================================================================
echo  === [2] ls -al unix.pdf.bin unix.pdf.bini.$osname.API.dec
echo  ====================================================================================================
ls -al unix.pdf.bin unix.pdf.bin.$osname.API.dec


echo 
echo  ====================================================================================================
echo  === [3] diff unix.pdf.bin unix.pdf.bin.$osname.API.dec
echo  ====================================================================================================
diff unix.pdf.bin unix.pdf.bin.$osname.API.dec

echo 
echo  ====================================================================================================
echo  === [4] cp unix.pdf.bin.$osname.API.enc OS_verify
echo  ====================================================================================================
cp unix.pdf.bin.$osname.API.enc OS_verify
