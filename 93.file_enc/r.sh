...
# use environment ..
 ...
 $JAVAHOME/java -d64 co_file 0    E AES256 unix.pdf.bin
#$JAVAHOME/java -d64 co_file 0    D AES256 unix.pdf.bin
 $JAVAHOME/java -d64 co_file 1024 E AES256 unix.pdf.bin
 $JAVAHOME/java -d64 co_file 64   E AES256 unix.pdf.bin
