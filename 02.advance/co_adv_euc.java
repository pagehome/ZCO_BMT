...
public class co_adv_euc {
    ...
    static String plain = "¿œ¿ÃªÔªÁø¿¿∞ƒ•";
    ...
    static void basic_getbyte() throws Exception {
        ...
        encrypt = CubeOneAPI.coencbytes(bytehan, bytehan.length, item, 11, null, null, errbyte);
        byteEnc = CubeOneAPI.coencbyteb(bytehan, bytehan.length, item, 11, null, null, errbyte);
        ...
        System.out.println("<<< CubeLog :: encrypt = [" + new String(encrypt.getBytes("UTF-8")) + "]");
        ...
        byte[] decByte = CubeOneAPI.codecbyteb(byteEnc,byteEnc.length,item,11,null,null,errbyte);
        decrypt = new String(decByte,"EUC-KR");
        //decrypt = new String(decByte);  // get Default JVM file.encoding
