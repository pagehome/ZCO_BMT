...
public class FileEncIns {
    public static void main(String args[]){
        ...
        try {
            ...
            /* File load */
            java.io.File fl = new java.io.File("./tt.jpg");
            ...
            while ((len=src.read(buffer)) >= 0) {
                ...
                encblob = CubeOneAPI.coencbytes(buffer,fileSize, "SSN", 11, "", "", errbyte); //byte
                System.out.println("Enc FileSize=["+encblob.length()+"]");
                in=new ByteArrayInputStream( encblob.getBytes() );
                pstmt.setBinaryStream(1, in, encblob.length());
