...
#$JAVAHOME/javac  -encoding UTF-8 -classpath $HOME/lib/CubeOneAPI.jar:../ojdbc14.jar -d . *.java
$JAVAHOME/javac  -classpath $HOME/lib/CubeOneAPI.jar:../ojdbc14.jar -d . *.java
#$JAVAHOME/javac -encoding EUC-KR  -classpath $HOME/lib/CubeOneAPI.jar:../ojdbc14.jar -d . *.java
